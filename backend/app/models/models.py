...
class Trade(Base):
    ...
    nifty_active_high = Column(Numeric(10, 2))
    nifty_active_high_time = Column(DateTime(timezone=True))
    nifty_active_low = Column(Numeric(10, 2))
    nifty_active_low_time = Column(DateTime(timezone=True))
