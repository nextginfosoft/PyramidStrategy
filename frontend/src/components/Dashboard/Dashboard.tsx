        ...
        <div className="col-span-12 lg:col-span-3 space-y-3">
          ...
          <div className="glass-card rounded-xl p-3">
            ...
            {(() => {
              ...
              if (status?.ce && status.ce.nifty_active_high != null) legs.push({ side: 'CE', leg: status.ce })
              if (status?.pe && status.pe.nifty_active_high != null) legs.push({ side: 'PE', leg: status.pe })
